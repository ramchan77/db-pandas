...
df1.to_csv('Outlook_HR_data_updated.csv',sep=';',encoding='utf-8',index=None)
df3.to_csv('Link_HR_data_updated_with_duplicates.csv',sep=';',encoding='utf-8',index=None)
df3.drop_duplicates().to_csv('Link_HR_data_updated.csv',sep=';',encoding='utf-8',index=None)
